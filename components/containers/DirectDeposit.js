      ...
      <div className="form-group">
        ...
        <div className="row card-bank-account" id="js-card-royalties">
          <div className="card card--elevate col col-8">
            ...
            <div className="row"><input className="col col-12 js-account-holder" placeholder="Name of Account Holder"/></div>
            <div className="row"><input className="col col-12 js-bank-name" placeholder="Bank Name"/></div>
            <div className="row"><input className="col col-12 js-routing-number" placeholder="Routing Number"/></div>
            <div className="row"><input className="col col-12 js-account-number" placeholder="Account Number"/></div>
            <div className="row">
              <select className="col col-12 js-account-type">
